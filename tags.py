...
class TagCog(commands.Cog):
    ...
    def _create_tag_embed(self, tag_name, tag_content):
    ...
    async def set_tag(self, interaction: discord.Interaction, tag_name: str, tag_content: str):
    ...
    @app_commands.command()
    async def get_all_tags(self, interaction: discord.Interaction):
